...
LSM:Register("font", "Continuum Medium", [[Interface\AddOns\ElvUI\media\fonts\Continuum_Medium.ttf]], LSM.LOCALE_BIT_ruRU )
...
LSM:Register("font", "big_noodle_titling", [[Interface\Addons\SharedMedia\fonts\big_noodle_titling.ttf]], LSM.LOCALE_BIT_koKR + LSM.LOCALE_BIT_ruRU + LSM.LOCALE_BIT_zhCN + LSM.LOCALE_BIT_zhTW + LSM.LOCALE_BIT_western)
...
LSM:Register("statusbar","ElvUI Life", [[Interface\AddOns\ElvUI\media\textures\life.tga]])